      ...
      <div class="container">
        ...
        <div class="row gy-4">
          <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/UIA.jpg" class="img-fluid mb-4" alt="">
      ...
      <div class="container-fluid" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide event-item d-flex flex-column justify-content-end" style="background-image: url(assets/img/he&she.jpg)">
              <h3>Starts from RM9.99</h3>
              <div class="price align-self-start">EVOKE</div>
              <p class="description">
            ...
            <div class="swiper-slide event-item d-flex flex-column justify-content-end" style="background-image: url(assets/img/M1.jpg)">
              <h3>Starts from RM9.99</h3>
              <div class="price align-self-start">Mahallah Faruq</div>
              <p class="description">
                Mahallah Al-Faruq Cafeteria at IIUM serves local favorites like nasi goreng and maggi goreng in a spacious internet cafe setting, with mixed reviews on food quality.
              </p>
            </div><!-- End Event item -->

            <div class="swiper-slide event-item d-flex flex-column justify-content-end" style="background-image: url(assets/img/M2.jpg)">
              <h3>Starts from RM9.99</h3>
              <div class="price align-self-start">Mahallah Ali</div>
              <p class="description">
                Mahallah Ali Cafeteria at IIUM offers diverse options with a famous Somali yogurt in a cafeteria setting.
              </p>
            </div><!-- End Event item -->

            <div class="swiper-slide event-item d-flex flex-column justify-content-end" style="background-image: url(assets/img/M3.jpg)">
              <h3>Starts from RM9.99</h3>
              <div class="price align-self-start">Mahallah Ruqaiyah</div>
              <p class="description">
                Mahallah Ruqayyah Cafeteria at IIUM offers local and Western fare in a large cafeteria setting with positive reviews for shawarma, pizza, and Mee Kari.
              </p>
            </div><!-- End Event item -->
